...
gem5 -m gem5.utils.multisim multisim-experiment.py path/to/multisim-experiment.py
...
multisim.set_num_processes(1)

for data_cache_size in ["8kB"]:  # ,"16kB"]:
    for instruction_cache_size in ["8kB"]:  # ,"16kB", "32kB"]:
